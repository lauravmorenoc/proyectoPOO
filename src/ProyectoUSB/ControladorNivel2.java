...
import ProyectoUSB.Controlador;
import ProyectoUSB.ControladorNivel1;
import ProyectoUSB.Enemy;
import ProyectoUSB.Hole;
import ProyectoUSB.Modelo;
import ProyectoUSB.Nivel2;
import ProyectoUSB.Singleton;
 ...
 * @author Juan
 */
public class ControladorNivel2 extends Controlador{
   private Nivel2 ventana;
    private Modelo modelo;
    
    public ControladorNivel2(Modelo modelo){
        this.movY=true;
        this.movX=true;
        this.ventana = new Nivel2();
        this.modelo=modelo;
