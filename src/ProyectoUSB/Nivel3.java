...
import ProyectoUSB.Background;
import ProyectoUSB.Enemy;
import ProyectoUSB.Hole;
import ProyectoUSB.Player;
import ProyectoUSB.StaticObject;
import ProyectoUSB.Vista;
 ...
 * @author Juan
 */
public class Nivel3 extends Vista {
     // private Scene scene;
    ...
    public Nivel3(){
        ...
        this.floor= new StaticObject(0, 371, 300, 200, new Image("Imagenes/floor2.png"));
        this.bg=new Background(0, 0, 650, 406, new Image("Imagenes/esc3.jpg"));
        this.bgInverted=new Background(0, 0, 650, 406, new Image("Imagenes/esc3.jpg"));
