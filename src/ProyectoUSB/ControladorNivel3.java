 ...
 * @author Juan
 */
public class ControladorNivel3 extends Controlador {
private Nivel3 ventana;
    private Modelo modelo;
    
    public ControladorNivel3(Modelo modelo){
        this.movY=true;
        this.movX=true;
        this.ventana = new Nivel3();
        this.modelo=modelo;
